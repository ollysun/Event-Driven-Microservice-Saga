package com.moses.eshop.productservice.core.errorhandling;
...
public class ProductsServiceErrorHandler {
	...
	public ResponseEntity<Object> handleQueryExecutionException(CommandExecutionException ex, WebRequest request) {
		ErrorMessage errorMessage = new ErrorMessage(new Date(), ex.getMessage());
